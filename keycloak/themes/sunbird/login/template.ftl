                ...
                <div id="kc-content-wrapper" class="${properties.kcContentWrapperClass!}">
                    ...
                    <script type="text/javascript">
                        ...
                        if(sessionTenant){
                            ...
                            var imgSrc = "${url.resourcesPath}/img/igot_karmayogi.svg";
                        }
                        ...
                        if(logoImg){
                            ...
                            logoImg.src = imgSrc;
                            logoImg.addEventListener("error", ()=>{ logoImg.onerror=null;logoImg.src='${url.resourcesPath}/img/igot_karmayogi.svg'});
                        }
